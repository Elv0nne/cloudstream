...
android {
    ...
    defaultConfig {
        applicationId = "com.ThitboKobe.Anime47"
    ...
    productFlavors {
        create("stable") {
            dimension = "state"
            // The "prerelease" signingConfig is reused here (it's keyed
            // off SIGNING_KEY_ALIAS, not the flavor name) so that
            // assembleStableRelease also produces a signed APK instead
            // of silently falling back to unsigned output.
